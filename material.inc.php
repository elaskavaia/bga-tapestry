...
$this->structure_types = // 
        array(
                BUILDING_MARKET => array("name" => clienttranslate("Market"), "mask" => ["1"]),
...
// #tt - type of table, ct - type of card (card_type), dest - where to pay it
 ...
 327 => [  // BE_TERRITORY_BE_BLACKDIE
  'name' => clienttranslate("Territory Benefit"),
  'auto'=>1,
],
 328 => [  // BE_TERRITORY_BE_SELECT
...
$this->civilizations = array(
        CIV_ALCHEMISTS => [
                ...
                "description@a8" => [
                        ...
                        clienttranslate("<li> Science die: Advance on the track and gain the resulting benefit (you may pay to gain the bonus, if any)."),
        ...
        14 => array(
                ...
                "description@a8" => [
                        ...
                        clienttranslate("Whenever you gain a building or landmark, you may place it either in your capital city or on the map in 1 of 2 locations:"),
                        clienttranslate("<b>On a territory you control containing exactly 1 other token (outpost, building, or player token).</b> If you do, gain [ANY RESOURCE]. Opponents can't conquer these territories."),
                        clienttranslate("<b>On an empty territory adjacent to one you control.</b> This gives you control of that territory, but it is not a conquer action. It is considered an outpost if an opponent conquers it."),
                        clienttranslate("You still gain building-related benefits (e.g. [HOUSEVP]) whether they're on the map or in your capital city."),
                        clienttranslate("<i>If you gain this civilization in the middle of the game, gain an income building of the type you have the least of (if tied, you choose) and place it as indicated above.</i>"),
                ],
                "al" => 8,
        ),
        CIV_CHOSEN => array(
