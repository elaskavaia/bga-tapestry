...
$this->territory_tiles = [
    // 0 is top left vertex. Rest follow clockwise
    1 => ["x" => [TERRAIN_SEA, TERRAIN_DESERT, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA], "benefit" => [BE_GAIN_COIN]],
    2 => [
        "x" => [TERRAIN_SEA, TERRAIN_MOUNTAIN, TERRAIN_MOUNTAIN, TERRAIN_DESERT, TERRAIN_DESERT, TERRAIN_SEA],
        "benefit" => [BE_2_TERRITORY],
    ],
    3 => ["x" => [TERRAIN_SEA, TERRAIN_MOUNTAIN, TERRAIN_DESERT, TERRAIN_DESERT, TERRAIN_SEA, TERRAIN_SEA], "benefit" => [BE_GAIN_FOOD]],
    4 => ["x" => [TERRAIN_SEA, TERRAIN_MOUNTAIN, TERRAIN_DESERT, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA], "benefit" => [BE_GAIN_CULTURE]],
    5 => [
        "x" => [TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA],
        "benefit" => [BE_GAIN_FOOD],
        "h" => [TERRAIN_DESERT],
    ],
    6 => ["x" => [TERRAIN_SEA, TERRAIN_DESERT, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA], "benefit" => [BE_GAIN_WORKER]],
    7 => [
        "x" => [TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA],
    ...
    18 => ["x" => [TERRAIN_SEA, TERRAIN_GRASS, TERRAIN_GRASS, TERRAIN_GRASS, TERRAIN_FOREST, TERRAIN_FOREST], "benefit" => [BE_MARKET]],
    19 => [
    ...
    49 => [
        "x" => [TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA],
        "h" => [TERRAIN_DESERT, TERRAIN_FOREST, TERRAIN_GRASS, TERRAIN_MOUNTAIN],
    ],
    50 => ["x" => [TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_FOREST, TERRAIN_SEA]],
    51 => ["x" => [TERRAIN_FOREST, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_FOREST, TERRAIN_FOREST]],
    52 => ["x" => [TERRAIN_MOUNTAIN, TERRAIN_FOREST, TERRAIN_FOREST, TERRAIN_FOREST, TERRAIN_SEA, TERRAIN_MOUNTAIN]],
    53 => ["x" => [TERRAIN_SEA, TERRAIN_DESERT, TERRAIN_MOUNTAIN, TERRAIN_MOUNTAIN, TERRAIN_SEA, TERRAIN_SEA]],
    54 => ["x" => [TERRAIN_MOUNTAIN, TERRAIN_MOUNTAIN, TERRAIN_GRASS, TERRAIN_GRASS, TERRAIN_MOUNTAIN, TERRAIN_SEA]],
    55 => ["x" => [TERRAIN_GRASS, TERRAIN_GRASS, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_GRASS]],
    56 => ["x" => [TERRAIN_SEA, TERRAIN_GRASS, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA]],
    57 => ["x" => [TERRAIN_SEA, TERRAIN_SEA, TERRAIN_MOUNTAIN, TERRAIN_FOREST, TERRAIN_FOREST, TERRAIN_SEA]],
    58 => ["x" => [TERRAIN_GRASS, TERRAIN_DESERT, TERRAIN_DESERT, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA]],
    59 => ["x" => [TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_GRASS, TERRAIN_GRASS, TERRAIN_DESERT]],
    60 => ["x" => [TERRAIN_SEA, TERRAIN_DESERT, TERRAIN_GRASS, TERRAIN_FOREST, TERRAIN_DESERT, TERRAIN_DESERT]],
    61 => ["x" => [TERRAIN_MOUNTAIN, TERRAIN_FOREST, TERRAIN_FOREST, TERRAIN_MOUNTAIN, TERRAIN_SEA, TERRAIN_MOUNTAIN]],
    62 => ["x" => [TERRAIN_SEA, TERRAIN_MOUNTAIN, TERRAIN_MOUNTAIN, TERRAIN_DESERT, TERRAIN_SEA, TERRAIN_SEA]],
    63 => ["x" => [TERRAIN_DESERT, TERRAIN_GRASS, TERRAIN_GRASS, TERRAIN_DESERT, TERRAIN_SEA, TERRAIN_DESERT]],
    64 => ["x" => [TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_DESERT, TERRAIN_SEA]],
    65 => ["x" => [TERRAIN_DESERT, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_DESERT, TERRAIN_DESERT]],
    66 => ["x" => [TERRAIN_GRASS, TERRAIN_DESERT, TERRAIN_DESERT, TERRAIN_DESERT, TERRAIN_SEA, TERRAIN_GRASS]],
    67 => ["x" => [TERRAIN_SEA, TERRAIN_MOUNTAIN, TERRAIN_GRASS, TERRAIN_GRASS, TERRAIN_SEA, TERRAIN_SEA]],
    68 => ["x" => [TERRAIN_FOREST, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_GRASS, TERRAIN_GRASS]],
    69 => ["x" => [TERRAIN_SEA, TERRAIN_FOREST, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_DESERT]],
    70 => ["x" => [TERRAIN_MOUNTAIN, TERRAIN_GRASS, TERRAIN_GRASS, TERRAIN_SEA, TERRAIN_MOUNTAIN, TERRAIN_MOUNTAIN]],
    71 => ["x" => [TERRAIN_FOREST, TERRAIN_FOREST, TERRAIN_DESERT, TERRAIN_DESERT, TERRAIN_SEA, TERRAIN_DESERT]],
    72 => ["x" => [TERRAIN_SEA, TERRAIN_MOUNTAIN, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA]],
    73 => ["x" => [TERRAIN_SEA, TERRAIN_MOUNTAIN, TERRAIN_MOUNTAIN, TERRAIN_MOUNTAIN, TERRAIN_SEA, TERRAIN_SEA]],
    74 => ["x" => [TERRAIN_FOREST, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_SEA, TERRAIN_GRASS, TERRAIN_FOREST]],
    75 => ["x" => [TERRAIN_MOUNTAIN, TERRAIN_GRASS, TERRAIN_GRASS, TERRAIN_SEA, TERRAIN_MOUNTAIN, TERRAIN_MOUNTAIN]],
    76 => ["x" => [TERRAIN_SEA, TERRAIN_SEA, TERRAIN_MOUNTAIN, TERRAIN_FOREST, TERRAIN_FOREST, TERRAIN_SEA]],
...
$this->terrain_types = [
    0 => ["name" => clienttranslate("Empty")],
    1 => ["name" => clienttranslate("Sea")],
    2 => ["name" => clienttranslate("Desert")],
    3 => ["name" => clienttranslate("Forest")],
    4 => ["name" => clienttranslate("Grass")],
    5 => ["name" => clienttranslate("Mountain")],
];
$this->structure_types =
    //
    [
        BUILDING_MARKET => ["name" => clienttranslate("Market"), "mask" => ["1"]],
        BUILDING_HOUSE => ["name" => clienttranslate("House"), "mask" => ["1"]],
        BUILDING_FARM => ["name" => clienttranslate("Farm"), "mask" => ["1"]],
        BUILDING_ARMORY => ["name" => clienttranslate("Armory"), "mask" => ["1"]],
        BUILDING_OUTPOST => ["name" => clienttranslate("Outpost"), "mask" => ["1"]],
...
$this->benefit_types = [
    ...
    80 => [
        // BE_ADVANCE_EXPLORATION_BENEFIT_NOBONUS
    ...
    85 => [
        // BE_ADVANCE_SCIENCE_NOBENEFIT_OPT
    ...
    86 => [
        // BE_ADVANCE_MILITARY_NOBENEFIT_OPT
    ...
    87 => [
        // BE_ADVANCE_TECHNOLOGY_NOBENEFIT_OPT
    ...
    88 => [
        // BE_ADVANCE_EXPLORATION_BENEFIT_OPT
    ...
    118 => [
        ...
        "tap" => 23,
        "s" => "c",
        "sflags" => FLAG_OPPONENT,
        "adv" => 0,
    ],
    119 => [
        // BE_STANDUP_3_OUTPOSTS
    ...
    120 => [
        ...
        "tap" => 36,
        "s" => "c",
        "sflags" => FLAG_OPPONENT | FLAG_VIRTUAL_ALLOWED,
        "aflags" => FLAG_ADVANCE | FLAG_REGRESS | FLAG_POSCLOSEST,
    ],
    121 => [
        //
    ...
    195 => [
        ...
        "name" => clienttranslate(
            "Choose 1 of your advancement tokens. Gain resources equal to the cost of advancing into its current position"
        ),
        "s" => "c",
        "sflags" => FLAG_SELF,
        "aflags" => FLAG_STAY,
    ...
    196 => [
        // BE_TINKERERS_2
        "name" => clienttranslate(
            "Advance on any track to match the closest opponent who is ahead of you on that track. You may gain the benefit but not the bonus."
        ),
        "s" => "c",
        "sflags" => FLAG_OPPONENT,
        "aflags" => FLAG_ADVANCE | FLAG_POSCLOSEST,
        "state" => "trackSelect",
    ],
    197 => [
        // BE_TINKERERS_3
        "name" => clienttranslate(
            "Regress exactly 3 spaces on an advancement track where this is possible. You may gain the benefit and pay to gain the bonus (if any)"
        ),
        "adv" => -3,
        "s" => "c",
        "sflags" => FLAG_SELF,
        "aflags" => FLAG_REGRESS | FLAG_POSEXACT,
        "state" => "trackSelect",
    ],
    198 => [
        // BE_TINKERERS_4
    ...
    322 => [
        // BE_TINKERERS_2a
        "name" => clienttranslate(
            "Advance on any track to match the closest opponent who is ahead of you on that track. Do not gain the benefit or the bonus."
        ),
        "s" => "c",
        "sflags" => FLAG_OPPONENT,
        "aflags" => FLAG_ADVANCE | FLAG_POSCLOSEST,
    ...
    323 => [
        // BE_TINKERERS_3a
        "name" => clienttranslate(
            "Regress exactly 3 spaces on an advancement track where this is possible. You may gain the benefit but not the bonus."
        ),
        "adv" => -3,
        "s" => "c",
        "sflags" => FLAG_SELF,
    ...
    324 => [
        //
        "name" => clienttranslate("Roll the black conquer die"),
    ],
    325 => [
        //
        "name" => clienttranslate("Roll the research die"),
    ],
    326 => [
        //
    ...
    327 => [
        // BE_TERRITORY_BE_BLACKDIE
        "name" => clienttranslate("Territory Benefit"),
        "auto" => 1,
    ],
    328 => [
        // BE_TERRITORY_BE_SELECT
        "name" => clienttranslate("Territory Benefit (Controlled)"),
    ],
    329 => [
        //
        "name" => clienttranslate("Roll all dice"),
        "civ" => CIV_ALCHEMISTS,
    ],
    330 => [
        // BE_CONQ_DIE_BLACK
        "name" => clienttranslate("Black die benefit"),
        "die" => "black",
        "r" => "die",
    ],
    331 => [
        // BE_CONQ_DIE_RED
        "name" => clienttranslate("Red die benefit"),
        "die" => "red",
        "r" => "die",
    ],
    332 => [
...
$this->tech_track_types = [
    1 => [
        ...
        "rot" => 0,
        "resource" => 3,
        "overview" => clienttranslate(
            "Pick a territory tile from your supply and place it on the map adjacent to a territory you control. Gain 1 VP per side of the tile with at least 1 aligned terrain (max 6). Then gain the benefit on the tile."
        ),
    ],
    2 => [
        "name" => "science",
        ...
        "resource" => 2,
        "overview" => clienttranslate(
            "Roll the science die. You may advance on the corresponding track for free. Unless there is an X on the research icon, gain the benefit and you may pay to gain the bonus (if any)."
        ),
    ],
    3 => [
        "name" => "military",
        ...
        "resource" => 4,
        "overview" => clienttranslate(
            "Place an outpost token from your supply onto a territory that has no more than 1 token on it and is adjacent to a territory you control. If the territory has an opponent's outpost, topple it. Also roll the 2 conquer dice and gain the benefit of 1 of them."
        ),
    ],
    4 => [
        "name" => "technology",
        ...
        "resource" => 1,
        "overview" => clienttranslate(
            "Gain a tech card (face up or from the top of the deck) and place it to the right of your capital city mat in the bottom row. Replenish each face-up tech card as you gain it."
        ),
    ],
];
$this->tech_track_data = [
    1 => [
        ...
        2 => [
            ...
            "description" => clienttranslate(
                "Explore: Place 1 territory tile from your supply on the map, gain 1 VP per aligning side, and gain the benefit on the tile."
            ),
        ...
        11 => [
            ...
            "description" => clienttranslate(
                "Gain 3 space tiles, then explore 1 of them (place explored space tiles next to your income mat)."
            ),
        ],
        12 => [
    ...
    2 => [
        ...
        11 => [
            ...
            "description" => clienttranslate(
                "Advance on 1 of these tracks, then gain the benefit & pay to gain the bonus (if any). Then do it again (same or different track)."
            ),
        ],
        12 => [
            ...
            "benefit" => [72, 72, 72, 72],
            "description" => clienttranslate(
                "Roll 4 science dice to advance (don't gain the benefits & bonuses). Gain 5 VP per die that would push you off a track."
            ),
        ],
        0 => [
    ...
    3 => [
        1 => [
            ...
            "benefit" => [BE_CONQUER],
            "description" => clienttranslate(
                "Conquer: Place an outpost on a territory adjacent to a territory you control. Roll the 2 conquer dice and pick 1 of the benefits rolled."
            ),
        ],
        2 => [
        ...
        7 => [
            ...
            "benefit" => [73],
            "description" => clienttranslate(
                "Conquer 1 territory. If that territory was controlled by an opponent, gain the benefits of both conquer dice."
            ),
            "landmark" => [38],
        ],
        8 => [
        ...
        10 => [
            ...
            "description" => clienttranslate(
                "Gain 1 VP per exploration track space you've advanced. Also play a tapestry on top of your current tapestry. Only the new card is active."
            ),
            "landmark" => [39],
        ],
        11 => [
        ...
        12 => [
            ...
            "description" => clienttranslate(
                "Conquer 1 territory (gain the benefits of both conquer dice). Also gain a random additional civilization."
            ),
        ],
        0 => [
    ...
    4 => [
        1 => [
            ...
            "benefit" => [BE_INVENT],
            "description" => clienttranslate(
                "Invent: Gain 1 tech card and place it to the right of your capital city mat in the bottom row. If you gained a faceup card, replenish it immediately."
            ),
        ],
        2 => [
        ...
        7 => [
            ...
            "description" => clienttranslate(
                "You may discard all 3 face-up tech cards and replace them. Invent 2 tech cards (one at a time)."
            ),
            "landmark" => [35],
        ],
        8 => [
        ...
        9 => [
            ...
            "description" => clienttranslate(
                "In any order, upgrade 1 tech card and gain the circle benefit of 1 tech card in your middle row."
            ),
        ],
        10 => [
        ...
        12 => [
            ...
            "description" => clienttranslate(
                "Remove your player token from the technology track and place it on the starting space of any track. Gain 1 of each resource. This track still counts as complete. <p><i>Note: if cube was removed from last space there will be a transparent cube as an indication of the max position on that track."
            ),
        ],
        0 => [
...
$this->landmark_data = [
    ...
    3 => [
        ...
        "mask" => [
            ...
            0 => [0 => [0 => 1, 1 => 1, 2 => 1, 3 => 1], 1 => [0 => 1, 1 => 1, 2 => 1, 3 => 1]],
        ],
    ],
    4 => [
    ...
    12 => [
        ...
        "mask" => [
            ...
            2 => [0 => [1, 1, 1], 1 => [1, 1, 1], 2 => [1, 1, 0]],
            3 => [0 => [1, 1, 1], 1 => [1, 1, 1], 2 => [0, 1, 1]],
        ],
    ],
    13 => [
...
$this->tech_card_data = [
    1 => [
        "name" => clienttranslate("Air Conditioning"),
        "circle" => ["benefit" => [BE_GAIN_WORKER], "description" => clienttranslate("Gain 1 worker.")],
        "square" => ["benefit" => [BE_HOUSE], "description" => clienttranslate("Gain 1 house.")],
        "requirement" => ["track" => 4, "level" => 4],
    ],
    2 => [
        "name" => clienttranslate("Ammonia"),
        "circle" => ["benefit" => [BE_FARM], "description" => clienttranslate("Gain 1 farm.")],
        "square" => [
            "benefit" => [BE_VP_FARM],
    ...
    3 => [
        "name" => clienttranslate("Anesthesia"),
        "circle" => ["benefit" => [BE_ARMORY], "description" => clienttranslate("Gain 1 armory.")],
        "square" => [
            "benefit" => [BE_VP_ARMORY],
            "description" => clienttranslate("Gain 1 VP for each armory in your capital city."),
        ],
        "requirement" => ["track" => 2, "level" => 4],
    ],
    4 => [
        "name" => clienttranslate("Assembly Line"),
        "circle" => [
            "benefit" => [BE_TECH_SQUARE],
            "description" => clienttranslate("Gain the square benefit of 1 tech card in your top row."),
        ],
        "square" => [
            "benefit" => [BE_TECH_CIRCLE],
    ...
    5 => [
        "name" => clienttranslate("Bakery"),
        "circle" => ["benefit" => [504], "description" => clienttranslate("Gain 4 VP.")],
        "square" => [
            "benefit" => [56],
    ...
    6 => [
        "name" => clienttranslate("Barn"),
        "circle" => ["benefit" => [503], "description" => clienttranslate("Gain 3 VP.")],
        "square" => [
            "benefit" => [57],
    ...
    7 => [
        ...
        "square" => [
            "benefit" => [62],
            "description" => clienttranslate(
                "Gain the benefit & pay to gain the bonus of your current position on any track. Use at most 1x/turn."
            ),
        ],
    ...
    8 => [
        ...
        "square" => ["benefit" => [507], "description" => clienttranslate("Gain 7 VP.")],
        "requirement" => ["track" => 1, "level" => 4],
    ],
    9 => [
        "name" => clienttranslate("Canned Food"),
        "circle" => ["benefit" => [BE_GAIN_FOOD], "description" => clienttranslate("Gain 1 food.")],
        "square" => ["benefit" => [507], "description" => clienttranslate("Gain 7 VP.")],
        "requirement" => ["track" => 3, "level" => 4],
    ],
    10 => [
        "name" => clienttranslate("Clocks"),
        "circle" => [
            "benefit" => [79],
    ...
    12 => [
        "name" => clienttranslate("Com Tower"),
        "circle" => ["benefit" => [15, 504], "description" => clienttranslate("Gain 5 VP.")],
        "square" => [
            "benefit" => [58],
    ...
    13 => [
        ...
        "circle" => ["benefit" => [BE_MARKET], "description" => clienttranslate("Gain 1 market.")],
        "square" => [
            "benefit" => [54],
    ...
    15 => [
        "name" => clienttranslate("Eyeglasses"),
        "circle" => ["benefit" => [BE_INVENT], "description" => clienttranslate("Invent 1 tech card.")],
        "square" => [
            "benefit" => [BE_VP_TECH],
    ...
    16 => [
        ...
        "circle" => ["benefit" => [BE_GAIN_FOOD], "description" => clienttranslate("Gain 1 food.")],
        "square" => ["benefit" => [BE_FARM], "description" => clienttranslate("Gain 1 farm.")],
        "requirement" => ["track" => 2, "level" => 4],
    ],
    17 => [
        "name" => clienttranslate("Library"),
        "circle" => ["benefit" => [15, BE_VP, BE_VP], "description" => clienttranslate("Gain 3 VP.")],
        "square" => [
            "benefit" => [59],
    ...
    18 => [
        ...
        "circle" => ["benefit" => [BE_GAIN_COIN], "description" => clienttranslate("Gain 1 coin.")],
        "square" => ["benefit" => [BE_MARKET], "description" => clienttranslate("Gain 1 market.")],
        "requirement" => ["track" => 3, "level" => 4],
    ],
    19 => [
        "name" => clienttranslate("Paper"),
        "circle" => ["benefit" => [BE_HOUSE], "description" => clienttranslate("Gain 1 house.")],
        "square" => [
            "benefit" => [BE_VP_HOUSE],
    ...
    20 => [
        "name" => clienttranslate("Penicillin"),
        "circle" => [
            "benefit" => [BE_RESEARCH_NB],
            "description" => clienttranslate("Research (no benefit/bonus)."),
        ],
        "square" => ["benefit" => [15, 504], "description" => clienttranslate("Gain 5 VP.")],
        "requirement" => ["track" => 2, "level" => 4],
    ],
    21 => [
    ...
    23 => [
        "name" => clienttranslate("Sewage & Plumbing"),
        "circle" => [
            "benefit" => [BE_GAIN_CULTURE],
            "description" => clienttranslate("Gain 1 culture."),
        ],
        "square" => ["benefit" => [BE_ARMORY], "description" => clienttranslate("Gain 1 armory.")],
        "requirement" => ["track" => 4, "level" => 4],
    ],
    24 => [
        "name" => clienttranslate("Siegecraft"),
        "circle" => [
            "benefit" => [78],
    ...
    25 => [
        "name" => clienttranslate("Stock Market"),
        "circle" => ["benefit" => [505], "description" => clienttranslate("Gain 5 VP.")],
        "square" => [
            "benefit" => [60],
    ...
    26 => [
        ...
        "circle" => [
            "benefit" => [BE_GAIN_CULTURE, BE_TERRITORY],
    ...
    27 => [
        "name" => clienttranslate("The Nail"),
        "circle" => [
            "benefit" => [BE_TAPESTRY],
            "description" => clienttranslate("Gain 1 tapestry card."),
        ],
        "square" => [
            "benefit" => ["or" => [BE_MARKET, BE_HOUSE, BE_FARM]],
    ...
    29 => [
        "name" => clienttranslate("Transistors"),
        "circle" => ["benefit" => [BE_GAIN_COIN], "description" => clienttranslate("Gain 1 coin.")],
        "square" => [
            "benefit" => [BE_GAIN_CULTURE, 504],
...
$this->tapestry_card_data = [
    0 => [
        "name" => clienttranslate("FACE DOWN CARD"),
        "type" => "era",
        "description" => clienttranslate(
            "This card was played face down during an income turn when the player did not have one in their hand."
        ),
    ],
    1 => [
    ...
    2 => [
        ...
        "benefit" => [101],
        "description" => clienttranslate(
            "WHEN PLAYED: Roll the science die. All players must advance on the resulting track; only you gain the benefit (you may pay to gain the bonus)."
        ),
    ],
    3 => [
        ...
        "type" => "era",
        "description" => clienttranslate(
            "THIS ERA: Whenever you explore, draw a total of 3 Territory tiles. Before you place a Territory tile, you may give 1 Territory tile to an opponent to gain 3 [VP]."
        ),
    ],
    4 => [
        ...
        "benefit" => [102],
        "description" => clienttranslate(
            "WHEN PLAYED: Gain 2 [ANY RESOURCE] if you have the fewest landmarks. If you have the most landmarks, gain 12 [VP]. Otherwise (and for ties), gain 1 [ANY RESOURCE] and 6 [VP]."
        ),
    ],
    5 => [
        ...
        "benefit" => [122],
        "description" => clienttranslate(
            "THIS ERA: Choose an opponent. You cannot conquer each other's territories. Whenever they upgrade a Technology, you gain the benefit after they do."
        ),
    ],
    6 => [
        ...
        "benefit" => [103],
        "description" => clienttranslate(
            "WHEN PLAYED: For each advancement track where there are no further-advanced tokens than yours, gain 4 [VP]."
        ),
    ],
    7 => [
        ...
        "type" => "era",
        "description" => clienttranslate(
            "THIS ERA: You cannot advance on the military track. Each time an opponent advances on the military track, you gain 3 [VP]."
        ),
    ],
    8 => [
        ...
        "type" => "era",
        "description" => clienttranslate(
            "THIS ERA: When you gain income, gain 2 [VP] per [COIN] earned. Whenever you gain Market, also gain [COIN]."
        ),
    ],
    9 => [
    ...
    10 => [
        ...
        "benefit" => [105],
        "description" => clienttranslate(
            "WHEN PLAYED: Choose a territory tile you control and gain each of the following resources based on its land terrain(s): mountain([WORKER]), grassland([CULTURE]), forest([FOOD]), desert([COIN])."
        ),
    ...
    12 => [
        ...
        "benefit" => [107],
        "description" => clienttranslate(
            "WHEN PLAYED: Draw 3 Tapestry, then discard any number of Tapestry from your hand to gain 2 [VP] each."
        ),
    ],
    13 => [
        ...
        "type" => "now",
        "description" => clienttranslate(
            "WHEN PLAYED: Advance on any track and gain the benefit (you may pay to gain the bonus). Opponents may not advance on that track until after your next turn."
        ),
        "benefit" => [108],
    ],
    14 => [
    ...
    16 => [
        ...
        "type" => "era",
        "description" => clienttranslate(
            "THIS ERA: If you advance on the science track, gain 2 [VP]. Whenever you roll the science die, instead roll it twice and choose 1 result."
        ),
    ],
    17 => [
    ...
    18 => [
        ...
        "type" => "era",
        "description" => clienttranslate(
            "THIS ERA: Whenever you place a territory tile on the board, you may gain double the benefit on the tile, but no [VP]"
        ),
    ],
    19 => [
    ...
    21 => [
        ...
        "benefit" => [114],
        "description" => clienttranslate(
            "WHEN PLAYED: Pay 5 [VP] / 10 [VP] / 15 [VP] to gain 1 / 2 / 3 [ANY RESOURCE] or pay 1 / 2 / 3 [ANY RESOURCE] to gain 5 [VP] / 10 [VP] / 15 [VP]. You cannot spend VP you don't have."
        ),
    ],
    22 => [
        ...
        "type" => "era",
        "description" => clienttranslate(
            "THIS ERA: Whenever you invent a Technology, gain the Circle benefit on it. The card remains in the bottom row for now."
        ),
    ],
    23 => [
        ...
        "type" => "era",
        "description" => clienttranslate(
            "THIS ERA: Choose a track and an opponent. After they gain any benefit on that track, you gain it too (do not gain the bonus)."
        ),
        "benefit" => [118],
    ],
    24 => [
        ...
        "type" => "era",
        "description" => clienttranslate(
            "THIS ERA: When you gain income, you may convert [FOOD] to any other resource. For each [FOOD] you convert, gain 2 [VP]."
        ),
    ],
    25 => [
    ...
    26 => [
        ...
        "type" => "era",
        "description" => clienttranslate(
            "THIS ERA: Whenever you explore a territory, you may place an outpost on the newly explored territory."
        ),
    ],
    27 => [
    ...
    28 => [
        ...
        "benefit" => [115],
        "description" => clienttranslate(
            "WHEN PLAYED: Choose an advancement track. Your neighbours and you may advance once on that track; only you gain the benefit & may pay to gain the bonus (if any)."
        ),
    ],
    29 => [
        ...
        "benefit" => [116],
        "description" => clienttranslate(
            "WHEN PLAYED: In order starting with you, each player may pay [WORKER] to gain 10 [VP]. If at least 1 opponent does this, you gain 1 building from your income mat. If no opponents do this, you gain [COIN]"
        ),
    ],
    30 => [
        ...
        "type" => "era",
        "description" => clienttranslate(
            "THIS ERA: Whenever you topple an opponent's outpost, gain the results of both conquer dice. Traps cannot be played against you."
        ),
    ],
    31 => [
        ...
        "type" => "era",
        "description" => clienttranslate(
            "THIS ERA: Whenever you conquer a territory tile, gain the benefit on that tile (in addition to the benefit of the conquer dice)"
        ),
    ],
    32 => [
        ...
        "benefit" => [117],
        "description" => clienttranslate(
            "WHEN PLAYED: For each track where all tokens are more advanced than yours, gain 2 [VP] and [ANY RESOURCE]."
        ),
    ],
    33 => [
        ...
        "description" => clienttranslate(
            "WHEN PLAYED: Advance on each track exactly once. Do not gain the benefits. You may gain any resulting bonuses for free."
        ),
    ],
    34 => [
        ...
        "type" => "era",
        "description" => clienttranslate(
            "THIS ERA: Whenever you gain a landmark on a track, also gain [ANY RESOURCE]. If you reach an already-claimed landmark on a track, gain Armory."
        ),
    ],
    35 => [
        ...
        "description" => clienttranslate(
            "WHEN PLAYED: Gain [ANY RESOURCE] OR choose up to 3 territories containing your toppled outposts. Stand up those outposts and topple those opponent outposts."
        ),
    ],
    36 => [
        ...
        "benefit" => [120],
        "description" => clienttranslate(
            "WHEN PLAYED: Choose an advancement track. Advance or regress (your choice) to match the closest opponent. Do not gain the benefit/bonus."
        ),
    ],
    37 => [
        ...
        "benefit" => [121],
        "description" => clienttranslate(
            "WHEN PLAYED: Invent a face-up Technology and upgrade it. Your neighbours (right, then left) then each invent Technology from top of deck."
        ),
    ],
    38 => [
        ...
        "benefit" => [123],
        "description" => clienttranslate(
            "WHEN PLAYED: If you are the first player to enter this era, gain Technology and upgrade it. If you are not the first player to enter this era, gain 3 [VP] per opponent in the game."
        ),
    ],
    39 => [
        ...
        "type" => "era",
        "description" => clienttranslate(
            "THIS ERA: You may construct buildings on impassable land in your capital city. Whenever you do, gain 5 [VP]."
        ),
    ],
    40 => [
        ...
        "type" => "era",
        "description" => clienttranslate(
            "THIS ERA: You cannot advance on the science track. Whenever you enter any new advancement tier (I-IV), gain 4 [VP]."
        ),
    ],
    41 => [
        ...
        "benefit" => [124],
        "description" => clienttranslate(
            "WHEN PLAYED: Choose the current position of an opponent on any advancement track. You gain the corresponding benefit. If there is a bonus, that opponent gains it for free."
        ),
    ],
    42 => [
        ...
        "benefit" => [510],
        "description" => clienttranslate(
            "You may discard this card from your hand when an opponent tries to conquer your territory. If you do, gain [ANY RESOURCE] and topple their outpost.<hr>WHEN PLAYED: If played as a tapestry, gain 10 [VP]."
        ),
    ],
    43 => [
        ...
        "type" => "era",
        "description" => clienttranslate(
            "THIS ERA: If you gain a Tapestry, you may immediately play it on top of this card. The first and only time you do, gain 5 [VP]."
        ),
    ],
    44 => [
...
$this->civilizations = [
    CIV_ALCHEMISTS => [
        "name" => clienttranslate("ALCHEMISTS"),
        "description" => [
            clienttranslate(
                "The Alchemists love to push their luck in the hopes of accelerated advancement. <b>At the beginning of your income turns (2-5)</b>, roll the science die and mark the result here with a player token. You may then roll again or stop."
            ),
            clienttranslate(
                "If you roll an advancement you've already rolled, you bust. Remove all tokens and gain [ANY RESOURCE] as consolation for your terrible luck. Otherwise, when you stop, you may advance on each of the advancement tracks you rolled (don't gain benefits or bonuses). Then remove all tokens."
            ),
        ...
        "description@a4" => [
            ...
            clienttranslate(
                "If you roll an advancement you've already rolled, you bust and may regress once on the duplicated track (gain benefit/bonus). Otherwise, when you stop, you may advance once on your choice of one track you rolled (gain benefit/bonus). Either way, remove all tokens."
            ),
            clienttranslate("Each time the final results of this ability would push you off the end of a track, gain 5 [VP]."),
        ],

        "description@a8" => [
            clienttranslate("<i>The Alchemists, perhaps foolishly, attempt to make unstable-but-potent elixers.<i>"),
            clienttranslate("<b>At the beginning of your income turns (2-5)</b>, research elixers:"),
            clienttranslate("<br>1. Roll all three dice; you may reroll all dice once. Select one die to place on this mat."),
            clienttranslate("<br>2. Roll the two remaining dice; you may reroll both dice once. Select one die to place on this mat."),
            clienttranslate("<br>3. Gain the benefits of the two dice on this mat as noted below:"),
            clienttranslate(
                "<li> Science die: Advance on the track and gain the resulting benefit (you may pay to gain the bonus, if any)."
            ),
            clienttranslate("<li> Red conquer die: Gain double the victory points."),
            clienttranslate("<li> Black conquer die: Gain the benefits as indicated below"),
            clienttranslate("The [TERRITORY FACE] is a benefit is on a territory you control"),
        ...
        "slots_description@a8" => " ",
        "slots@a8" => [
            //
            ["benefit" => [BE_GAIN_COIN, BE_INVENT]],
            ["benefit" => [BE_TERRITORY_BE_SELECT, BE_ANYRES]],
            ["benefit" => [BE_GAIN_WORKER, BE_RESEARCH_NB]],
            ["benefit" => [BE_GAIN_FOOD, BE_EXPLORE]],
            ["benefit" => [BE_GAIN_CULTURE, BE_CONQUER]],
            //
        ],
        "al" => 8,
    ],
    CIV_ARCHITECTS => [
        ...
        "description" => [
            ...
            "",
            clienttranslate(
                "Each time you complete a district, if all income buildings in it are identical, gain +1 [ANY RESOURCE]. There must be at least 1 income building in that district."
            ),
            clienttranslate(
                "Whenever you score your capital city, for each complete row/column where all the income buildings are identical (min. 1), that row/column is worth 1 VP extra."
            ),

            clienttranslate(
                "<i>If you gain this civilization in the middle of the game, you may immediately swap the positions of 2 income buildings in your capital city. You may then repeat this up to 2 more times.</i>"
            ),
        ],
        "midgame_setup" => true,
        "adjustment" => clienttranslate(
            "When starting the game with the Architects in a game with 3 or more total players, gain 10 VP per opponent."
        ),
        "adjustment@a4a8" => clienttranslate("rules change"),
        "description@a4a8" => [
            1 => clienttranslate(
                "When starting the game with the Architects, place 1 cube per opponent on your capital city to create an impassable plot. Each cube must be placed in a different district."
            ),
        ],
        "al" => 8,
    ],
    CIV_CRAFTSMEN => [
        ...
        "description" => [
            clienttranslate(
                "The Craftsmen want to create a wonder of the world, a massive statue. You may place income buildings here as an alternative to your capital city. You must place each building on the lowest available space in a column of your choice (you don't need to finish a column before starting another). As you cover a benefit, gain it immediately."
            ),
            clienttranslate(
                "This grid counts as part of your capital city for building related benefits, but it does not score for completed rows and columns here."
            ),
        ],
        "description@a8" => [
            clienttranslate("The Craftsmen want to create a wonder of the world, a massive statue."),
            clienttranslate(
                "You may place income buildings here as an alternative to your capital city. You must place each building on the lowest available space in a column of your choice (you don't need to finish a column before starting another). As you cover a benefit, gain it immediately."
            ),
            clienttranslate(
                "This grid counts as poart of your capital city for building-related benefits (e.g., [HOUSEVP]), but it does not score for completed rows and columns here."
            ),
            clienttranslate(
                "If you gain this civilization in the middle of the game, you may place up to 1 of your tokens in each column on this mat and gain only one of the covered benefits (you choose). You can place each token on a row as high as the number of your current era (for example, gaining them in era 3 allows you to put tokens on the first 3 rows from the bottom). After that, you can place the income buildings you gain on the lowest spaces above these tokens and gain the benefits like you normally would."
            ),
        ],
        "slots" => [
    ...
    CIV_ENTERTAINERS => [
        ...
        "description" => [
            clienttranslate(
                "The Entertainers seek to spread their influence by entertaining various sectors of society. Start with a player token on the far left. <b>At the beginning of your income turns (2-5)</b>, advance the token one space to the right along a path and gain the benefit."
            ),
            clienttranslate(
                "<i>If you gain this civilization in the middle of the game, start with a player token on any space here and gain the benefit.</i>"
            ),
        ],
        "description@a4a8" => [
            clienttranslate(
                "The Entertainers seek to spread their influence by entertaining various sectors of society. Start with a player token on the far left. <b>At the beginning of your income turns (1-4)</b>, advance the token one space to the right along a path and gain the benefit."
            ),
            clienttranslate(
                "<i>If you gain this civilization in the middle of the game, start with a player token on any space here and gain the benefit.</i>"
            ),
    ...
    CIV_FUTURISTS => [
        "name" => clienttranslate("FUTURISTS"),
        "description" => [
            clienttranslate("The Futurists mysteriously begin their civilization with significant advancements."),
            clienttranslate(
                "<b>When you gain this civilization:</b> Advance on each track by exactly 4 spaces (with the end of each track as the limit). Do not gain benefits, bonuses, or landmarks. Also, gain 1 of each resource."
            ),
            "",
        ],
        ...
        "description@a4a8" => [
            clienttranslate("The Futurists mysteriously begin their civilization with significant advancements."),
            clienttranslate(
                "At the end of your first income turn (or immediately if you gain the Futurists during the game), you may advance on up to two different tracks by exactly 4 spaces (with the end of each track as a limit). Do not gain benefits, bonuses, or landmarks."
            ),
            clienttranslate(
                "Also gain 2 [ANY RESOURCE] (whether or not you advance). Landmarks left in this way are available to gain later."
            ),
        ], //
        "adjustment@a4a8" => clienttranslate("rules change"),
    ...
    6 => [
        "name" => clienttranslate("HERALDS"),
        "description" => [
            "<i>",
            clienttranslate("The Heralds proclaim their achievements worldwide. Start with 4 player tokens here."),
            "</i>",
            clienttranslate(
                "If you start the game with this civilization, at the end of your first income turn, you may play a tapestry card on top of Maker of Fire."
            ),
            clienttranslate(
                "<b>At the beginning of your income turns (2-5)</b>, you may place 1 player token on any WHEN PLAYED tapestry card (yours or an opponent's). Gain the benefits of that card. Each tapestry may have at most 1 token."
            ),
        ],
        "description@a4a8" => [
            1 => clienttranslate("The Heralds proclaim their achievements worldwide."),
            3 => clienttranslate(
                "<b>At the end of your first income turn</b>, draw and discard tapestry cards until you find a WHEN PLAYED or CONTINIOUS card. Then, you may palce a WHEN PLAYED or CONTINIOUS tapestry card on top of Maker of Fire (only place it; do not gain its immediate benefit). The Heralds may not play the Renaissance card over Maker of Fire."
            ),
        ],
        "tokens_count" => 4,
        "slots_description" => "",
    ...
    8 => [
        "name" => clienttranslate("INVENTORS"),
        "description" => [
            clienttranslate(
            ...
            clienttranslate(
                "Whenever an opponent's tech card with your token on it is upgraded to the top row, the opponent gains the benefit and then you gain the tech card, placing it in your bottom row. Your token remains on it. Landmarks on tech cards already gained by the opponent do nothing for you."
            ),
            clienttranslate(
                "<b>Rulings:</b> You can put your token on the card which already has your inventor token. You cannot put token on the card in the top row - card in that row cannot be upgraded"
            ),
        ],
        ...
        "description@a8" => [
            ...
            clienttranslate(
                "<b>At the beginning of your income turns (2-5)</b>, you may place a player token on one of your or your opponent's tech cards. If that card is in the bottom or middle row, it is instantly upgraded, and it ignores top-row prerequisites*."
            ),
            clienttranslate(
                "If it is an opponent's tech card, you may gain the benfit after they do (if it's your card, gain the benefit as normal)."
            ),
            clienttranslate(
                "Whenever an opponent's tech card with your token on it is upgraded to their top row (by your action or theirs), after the benefits have been resolved, you gain the tech card, placing it on your bottom row. All tokens remain on it. Landmarks on tech cards already gained by the opponent do nothing for you."
            ),
            clienttranslate("<i>* Any tech card with an Inventor's token ignores the prerequisites during the rest of the game.</i>"),
        ],
        "slots@a2a1a4" => [
            1 => ["top" => 80, "left" => 18, "w" => 8.5, "h" => 5.5],
    ...
    CIV_ISOLATIONISTS => [
        ...
        "description" => [
            ...
            clienttranslate(
                "Whenever you conquer an empty territory, you may place 1 of these tokens there in addition to your outpost, preventing that territory from being conquered in the future. If you do, gain [ANY RESOURCE]."
            ),
            "",
            clienttranslate(
                "On your final income turn, score [VP] for the largest connected land mass of the same terrain type you control:"
            ),
        ...
        "description@a4a8" => [
            clienttranslate(
                "The Isolationists just want to be left alone. Start with 4 player tokens here (add 1 extra in 4-5 player games) and 2 territory tiles."
            ),
            clienttranslate(
                "Whenever you conquer an empty territory, you may place 1 of these tokens there in addition to your outpost; if you do, gain [ANY RESOURCE]."
            ),
    ...
    10 => [
        "name" => clienttranslate("LEADERS"),
        "description" => [
            clienttranslate("The Leaders excel at cultivating the leadership abilities of their citizens."),
            clienttranslate(
                "<b>At the beginning of your income turns (2-5)</b>, you may place a player token on an uncovered leader (square on this mat) to advance for free on the corresponding track. Gain the benefit, but do not gain the bonus."
            ),
            "",
        ],
    ...
    11 => [
        "name" => clienttranslate("MERRYMAKERS"),
        "description" => [
            clienttranslate("The Merrymakers frequently celebrate love and life; the longer the festival, the better."),
            clienttranslate(
                "Start with 1 player token at the bottom of each track. <b>At the beginning of your income turns (2-5)</b>, select 1 token to advance upwards and gain the first benefit it lands on."
            ),
        ],
        "midgame_setup" => true,
        "slots" => [
            ...
            12 => ["top" => 71, "left" => 39, "benefit" => [515], "link" => [], "w" => 11, "h" => 6],
        ],
        "description@a4" => [
            1 => clienttranslate(
                "Start with 1 player token on any benefit and another player token on another benefit. At the beginning of your income turns (2-5), you must move each token once orthogonally and gain the resulting benefit. Tokens can never share the same space."
            ),
        ],

        "description@a8" => [
            clienttranslate(
                "The Merrymakers frequently celebrate love and life; the longer the festival and the wilder the dance, the better."
            ),
            clienttranslate("Start with 2 player tokens here, each on a different benefit (do not gain the benefits)."),
            clienttranslate(
                "At the beginning of your income turns (2-5), you must move each token to an orthogonally adjacent space and gain the resulting benefit. Tokens can never share the same space. "
            ),
        ],
        "slots@a4a8" => [
            1 => ["top" => 90, "left" => 14, "benefit" => [], "link" => [2], "w" => 11, "h" => 6],
            2 => ["benefit" => [BE_INVENT], "link" => [3, 6], "top" => 84, "left" => 14], //
            3 => ["benefit" => [RES_WORKER, 0], "link" => [2, 4, 7], "top" => 76, "left" => 14], //
            4 => ["benefit" => [BE_EXPLORE, 0], "link" => [3, 8], "top" => 69, "left" => 14], //
            5 => ["top" => 90, "left" => 25, "benefit" => [], "link" => [6], "w" => 11, "h" => 6],
            6 => ["benefit" => [RES_FOOD, 0], "link" => [2, 7, 10], "top" => 84, "left" => 25], //
            7 => ["benefit" => [BE_VP_CAPITAL, 0], "link" => [3, 6, 8, 11], "top" => 76, "left" => 25], //
            8 => ["benefit" => [RES_CULTURE, 0], "link" => [7, 4, 12], "top" => 69, "left" => 25], //
            9 => ["top" => 90, "left" => 37, "benefit" => [], "link" => [10], "w" => 11, "h" => 6],
            10 => ["benefit" => [BE_CONQUER], "link" => [11, 6], "top" => 84, "left" => 37], //
            11 => ["benefit" => [BE_GAIN_COIN], "link" => [10, 12, 7], "top" => 76, "left" => 37], //
            12 => ["benefit" => [BE_RESEARCH_NB], "link" => [11, 8], "top" => 69, "left" => 37], //
        ], //
    ...
    12 => [
        ...
        "description" => [
            clienttranslate(
                "The Militants seek to reap the benefits of the territories they control. Start with 8 outposts covering the spaces on this card. Whenever you conquer, take an outpost from the far left of either row here. At the beginning of your income turns, gain all of the exposed benefits."
            ),
            "",
            clienttranslate(
                "<i>If you gain this civilization in the middle of the game, place your remaining outposts on these spaces from right to left (you choose the row for each outpost).</i>"
            ),
        ],
        "description@a4" => [
        ...
        "description@a8" => [
            ...
            clienttranslate(
                "Start with 8 outposts covering these hexes; also, start with 2 player tokens (instead of outposts) on your starting territory so you have extra outposts to use for conquering. *On BGA you just get 2 more outposts instead"
            ),
            ...
            clienttranslate(
                "* On your income turns, if this benefit is exposed, perform the conquer action only after all other exposed benefits are gained."
            ),
            clienttranslate(
                "<i>If you gain this civilization in the middle of the game, place your remaining outposts on these spaces from right to left (you choose the row for each outpost).</i>"
            ),
        ...
        "slots" => [
            1 => ["top" => 60, "left" => 30, "w" => 10, "h" => 7, "benefit" => [BE_GAIN_COIN]],
    ...
    CIV_MYSTICS => [
        ...
        "description" => [
            clienttranslate(
                "The Mystics boast of their ability to predict the future (they're actually just good planners). When you gain this civilization, use player tokens to select a number in each of these categories."
            ),
            clienttranslate(
                "When you reach that number the first time, gain [ANY RESOURCE]. On your final income turn, for each category you predicted exactly correct, gain 10 [VP]."
            ),
        ...
        "description@a4" => [
            1 => clienttranslate(
                "When you reach that number the first time, gain [ANY RESOURCE]. On your final income turn, for each category you predicted exactly correct, gain 20 [VP]."
            ),
            2 => clienttranslate(
                "<i>If you gain this civilization in the middle of the game, make a number of predictions equal to the number of remaining eras: four in Era 1, three in Era 2, two in Era 3 and one in Era 4.</i>"
            ),
        ],
        ...
        "description@a8" => [
            ...
            clienttranslate(
                "After playing your tapestry card on income turns (2-4), gain the top card of the public deck and discard your entire hand of tapestry cards to your private discard pile."
            ),
            clienttranslate(
                "Based on the quantity of cards discarded in this way, gain the following, then gain 2 cards from your private deck:"
            ),
            clienttranslate("<li>2 cards --> choose one: | "),
            clienttranslate(
                "<li>4 cards --> choose two different:   [CONQUER]/[ANY RESOURCE]/[INVENT]/[INCOME BUILDING] (do not place in the city)"
            ),
            clienttranslate(
                "<li>6 cards --> choose three different:   [CONQUER-BOTH DICE]/[ANY RESOURCE]/[INVENT]+[UPGRADE]/[INCOME BUILDING]"
            ),
            clienttranslate(
                "<i>If you gain this civilization in the middle of the game, proceed to create your private deck of 8 tapestry cards, draw 1 from it (adding it to your current hand), discard your entire hand to gain benefits as if it is your income turn, then draw 2 tapestry cards from your private deck.</i>"
            ),
        ],
        "al" => 8,
    ],
    14 => [
        ...
        "description" => [
            ...
            clienttranslate(
                "Whenever you gain a building or landmark, you may place it either in your capital city or on the map in 1 of 2 locations:"
            ),
            clienttranslate(
                "<b>On a territory you control containing exactly 1 other token (outpost or building).</b> If you do, gain [ANY RESOURCE]. Opponents can't conquer these territories."
            ),
            clienttranslate(
                "<b>On an empty territory adjacent to one you control.</b> This gives you control of that territory, but it is not a conquer action. It is considered an outpost if an opponent conquers it."
            ),
        ...
        "midgame_setup@a8" => true,
        "description@a8" => [
            clienttranslate("<i>The Nomads prefer to expand their civilization outwards rather than focusing on their capital city.</i>"),
            clienttranslate(
                "Whenever you gain a building or landmark, you may place it either in your capital city or on the map in 1 of 2 locations:"
            ),
            clienttranslate(
                "<b>On a territory you control containing exactly 1 other token (outpost, building, or player token).</b> If you do, gain [ANY RESOURCE]. Opponents can't conquer these territories."
            ),
            clienttranslate(
                "<b>On an empty territory adjacent to one you control.</b> This gives you control of that territory, but it is not a conquer action. It is considered an outpost if an opponent conquers it."
            ),
            clienttranslate(
                "You still gain building-related benefits (e.g. [HOUSEVP]) whether they're on the map or in your capital city."
            ),
            clienttranslate(
                "<i>If you gain this civilization in the middle of the game, gain an income building of the type you have the least of (if tied, you choose) and place it as indicated above.</i>"
            ),
        ],
        "al" => 8,
    ],
    CIV_CHOSEN => [
        "name" => clienttranslate("THE CHOSEN"),
        "description" => [
            clienttranslate(
                "<i>The Chosen seek glory unmatched by other civilizations, whom they look down upon with a mixture of bewilderment and pity.</i>"
            ),
            ...
            clienttranslate(
                "For each achievement you've earned, gain [ANY RESOURCE]. If it's your final income turn, instead gain 5 [VP] per achievement earned."
            ),
        ],
        ...
        "description@a4" => [
            1 => clienttranslate(
                "Start with a player token to the left of this track. When you complete any achievement (public or private), advance the token to gain either the benefit underneath or 5 VP."
            ),
            2 => clienttranslate(
                "You have access to five personal Achievements (in addition to the three public achievements); you may complete each of them once in any order."
            ),
            3 => "",
            4 => clienttranslate(
                "<i>If you gain this civilization in the middle of the game, account for public and private achievements you have completed by advancing your token on this track and gaining the benefits.</i>"
            ),
        ],
        "description@a8" => [
            1 => clienttranslate(
            ...
            2 => clienttranslate(
                "You have access to six private achievements (in addition to the three public achievements). At the end of any advance turn, place a player token on any private achievement(s) to note their current completion."
            ),
            3 => "",
            4 => clienttranslate(
                '<i>If you gain this civilization in the middle of the game, account for public and private achievements you\'ve currently earned by advancing your token on this track and gaining at most 2 benefits.</i>'
            ),
        ],
    ...
    CIV_TRADERS => [
        "name" => clienttranslate("TRADERS"),
        "description" => [
            clienttranslate(
                "The Traders prefer to connect with other civilizations economically, not militarily. Start with 4 player tokens here."
            ),
            clienttranslate(
                "<b>At the beginning of your income turns (2-5)</b>, you may place a player token from here on any territory on the map matching one of these descriptions:"
            ),
            clienttranslate(
                "<b>Empty territory:</b> Gain 1 [VP] per adjacent territory controlled by opponents. If an opponent later conquers this territory, you may gain the benefit of any unselected conquer die as if you rolled it."
            ),
            clienttranslate(
                "<b>Territory with exactly 1 opponent outpost token and nothing else:</b> Gain the benefit on the territory (if any)."
            ),
        ...
        "description@a4" => [
            ...
            2 => clienttranslate(
                "<li>Gain an income building and place it on a territory with exactly 1 opponent outpost token and nothing else; the opponent immediately gains the benefit revealed by the income building. The opponent controls the territory."
            ),
            3 => clienttranslate(
                "<li>Place a player token on a territory with exactly 1 opponent outpost token and nothing else: Gain the benefit on the territory (if any); you both share control of this territory for scoring purposes."
            ),
            4 => clienttranslate(
                "<li>Place a player token on a territory you control with exactly 1 outpost token and nothing else: Gain the benefit on the territory (if any)."
            ),
        ],
        "description@a8" => [
            ...
            clienttranslate(
                "At the beginning of your income turns (2-5), choose one of the following options. For the first two options, you must have a territory tile to give:"
            ),
            clienttranslate(
                "<li>Place a player token on a territory with exactly 1 opponent outpost and nothing else: Give a territory tile to that opponent, then you gain both the benfit on the traded territory tile and the benefit of the territory (if any) on which you just placed a player token. The opponent controls the territory."
            ),
            clienttranslate(
                "<li>Gain an income building and place it (toppled) on a territory with exactly 1 opponent outpost and nothing else: Give a territory tile to that opponent, then both you and your opponent gain the benefit revealed by the income building. The opponent controls the territory."
            ),
            clienttranslate(
                "<li>Place a player token on a territory you control with exactly 1 outpost and nothing else: Gain [ANY RESOURCE] or [5VP], then roll the black conquer die and gain the result; each opponent gains a territory tile."
            ),
        ],
        "tokens_count" => 4,
        "tokens_count@a8" => 0,
    ...
    // AA
    CIV_COLLECTORS => [
        "name" => clienttranslate("COLLECTORS"),
        "description" => [
            clienttranslate("<i>The collectors proudly display a variety of objects and buildings.</i>"),
            clienttranslate(
                "When you gain at least one of the following during an advancement turn, you may place one of them on this civilization mat if there isn't already one of that type here. Then gain listed benefit."
            ),
            clienttranslate("[OUTPOST]* [HOUSE] [LANDMARK] [TAPESTRY] [TERRITORY] [TECHNOLOGY]"),
            clienttranslate(""),
            clienttranslate(
                "At the end of the game, gain VP [1/3/6/10/15/21] according to the number of different objects on this civilization mat [1/2/3/4/5/6]."
            ),
            clienttranslate(
                "Items on your mat still count as yours for the purposes of scoring, but may no longer be used, upgraded, played, or discarded.  All cards and tiles are kept face down."
            ),
        ...
        "description@a8" => [
            ...
            7 => clienttranslate(
                "<i>If you gain this civilization in the middle of the game, you may place 1 [TAPESTRY] and/or 1 [TILE] from your supply on this mat; do not gain any immediate benefit.</i>"
            ),
        ],
        "slots_description" => "",
        "slots" => [
    ...
    CIV_GAMBLERS => [
        "name" => clienttranslate("GAMBLERS"),
        "description" => [
            clienttranslate("The Gamblers know when to hold 'em and know when to fold 'em."),
            clienttranslate(
                "If you start the game with this civilization, at the end of your first income turn reveal 3 tapestry cards. Play one with a WHEN PLAYED ability on top of Maker of Fire, resolve the ability, and discard the other revealed cards."
            ),
            clienttranslate("If you reveal no valid cards, add 1 of the revealed cards to your hand and discard the rest."),
            clienttranslate(
                "At the beginning of your income turns (2-4), reveal 3 tapestry cards. Play one with a WHEN PLAYED ability on top of the current era, resolve the ability, and discard the other revealed cards."
            ),
            clienttranslate("If you reveal no valid cards, add 1 of the revealed cards to your hand and discard the rest."),
        ...
        "description@a8" => [
            ...
            clienttranslate(
                "<b>At the end of your first income turn</b>, reveal 2 tapestry cards from the tops of the deck. Play one with a WHEN PLAYED ability on top of Maker of Fire, resolve the ability, and discard the other revealed card. If you reveal no WHEN PLAYED cards, add 1 of the revealed cards to your hand and discard the other."
            ),
            clienttranslate(
                "<b>At the beginning of your income turns (2-4)</b>, reveal 2 tapestry cards. Play one with a WHEN PLAYED ability on top of the current era, resolve the ability, and discard the other revealed card. If you reveal no WHEN PLAYED cards, add 1 of the revealed cards to your hand and discard the other. Then proceed to play your tapestry card for this era as normal (on top of it)."
            ),
            "",
            "",
            clienttranslate(
                "<i>If you gain this civilization in the middle of the game, you may immediately follow the instructions in the previous paragraph as if you were using the Gambler's ability on an income turn.</i>"
            ),
        ],
    ...
    CIV_RELENTLESS => [
        "name" => clienttranslate("RELENTLESS"),
        "description" => [
            clienttranslate("<i>The Relentless are always pushing for improvement, rushing forward without pause.</i>"),
            clienttranslate(
                "At the end of each of your income and advancement turns, if you gained at least one building (income or landmark) during that turn, place a player token on this civilization mat."
            ),
            clienttranslate(
                "At the end of each of your advancement turns, if you did not gain at least one building on that turn, remove all player tokens from this mat, and gain rewards based on the following chart ('/' means 'or'):"
            ),
        ...
        "description@a8" => [
            8 => clienttranslate(
                "If you gain this civilization in the middle of the game, place 4 player tokens on this mat. You may discard them now to gain the benefit."
            ),
        ],
        "slots_description" => "",
        "slots" => [
    ...
    CIV_RENEGADES => [
        "name" => clienttranslate("RENEGADES"),
        "description" => [
            clienttranslate(
                "The Renegades choose to forge their own path, advancing in ways that other civilizations cannot and finding shortcuts along the way."
            ),
            clienttranslate("Start with a player token on the start position of the Renegades' track."),
            clienttranslate(
                "When advancing on a track where you would gain the benefit, you may ignore its benefit (and bonus, if applicable) to advance on this track and gain its benefit instead. You still gain applicable landmarks. The tier you're advancing into or within must match the tier you are advancing into on this mat. This is the only way to advance on this track, and it is not considered an advancement track for other cards, abilities, achievements, etc."
            ),
    ...
    CIV_URBAN_PLANNERS => [
        "name" => clienttranslate("URBAN PLANNERS"),
        "description" => [
            clienttranslate(
            ...
            "",
            clienttranslate(
                "On your final income turn, gain VP according to the chart below for the largest group of connected landmarks in your capital city (where each landmark touches at least one other landmark orthogonally)."
            ),
    ...
    CIV_ADVISORS => [
        ...
        "description" => [
            ...
            clienttranslate(
                "At the beginning of your income turns (2-5), gain 1 VP per tapestry card in your hand. Then, if you have more than 4 tapestry cards in hand, you must discard down to exactly 4. If this causes you to discard at least 1 card, gain [ANY RESOURCE]."
            ),
            clienttranslate(
                "During advancement turns (not income turns) whenever a neighbor would gain a tapestry card, instead of them drawing from the deck, you may give them a card of your choice from your hand. If you do, after you give them a card, gain a tapestry card."
            ),
            clienttranslate(
                "<it>If you gain this civilization in the middle of the game, you may immediately give any/all of the starting 3 tapestry cards to neighbors, gaining 5 per card you give</it>"
            ),
        ],
        "description@a8" => [
            clienttranslate("The Advisors dispense an endless wealth of unsolicited advice to other civilizations."),
            ...
            clienttranslate(
                "Whenever an opponent would play a tapestry card on a space containing your player token, they first return the token to you and reveal 1 card from their hand that they would like to play:"
            ),
            clienttranslate(
                "<li> If it's a WHEN PLAYED card and you agree, they play the card. Afterwards, you also gain the benefit of the card."
            ),
            clienttranslate(
            ...
            clienttranslate(
                "<it>If you gain this civilization in the middle of the game, you may either discard it and gain another or immediately place up to 2 player tokens on spaces that do not have your player tokens on opponents' income mats.</it>"
            ),
        ],
    ...
    CIV_ALIENS => [
        ...
        "description" => [
            ...
            clienttranslate(
                "At the beginning of your income turns (2-5), if there is a space tile on this civilization mat, discard it. Then choose one of these options:"
            ),
            clienttranslate(
                "<li>Explore 1 space tile from your supply, placing it on this civilization mat. If you discarded a space tile from your civilization mat this turn, you must first pay [ANY RESOURCE]"
            ),
    ...
    CIV_INFILTRATORS => [
        ...
        "description" => [
            ...
            clienttranslate(
                "<li>Place a player token on an opponent's capital city territory and gain 1 VP for each outpost token that opponent hasn't placed on the board. If it's your third player token there, gain another civilization."
            ),
        ...
        "description@a8" => [
            ...
            clienttranslate(
                "<li>Place a player token on an opponent's capital city territory and gain [1VP] for each outpost that opponent hasn't placed on the board. If it's your third player token there, gain another civilization."
            ),
            clienttranslate("Whenever you would gain a new civilization, draw 3 and keep 1 (discard the others)"),
            clienttranslate(
                "If you gain this civilization in the middle of the game, give an opponent a player token in addition to the starting one."
            ),
        ],
        "exp" => "PP", //
    ...
    CIV_ISLANDERS => [
        ...
        "description" => [
            clienttranslate(
                "The Islanders are mystified by a massive island on the horizon, and they devote their resources to exploring it."
            ),
            clienttranslate("Start with 4 territory tiles in your supply."),
            clienttranslate(
                "At the beginning of your income turns (2-5), you may explore 1 of the hexes on this mat (place a territory tile here and gain the exploration benefit and, just as you would on the board). These hexes cannot be conquered, but they can be explored on advancement turns via exploration actions."
            ),
            "",
            clienttranslate(
                "On step 3 of your final income turn, gain 4 VP for each of these territory tiles that contain only water on the outer edges."
            ),
            "",
            clienttranslate(
                "<it>If you gain this civilization in the middle of the game, you may discard it and gain another. If you keep it, immediately place up to 4 of your territory tiles on these hexes (don't gain exploration benefits from this)</it>"
            ),
        ],

        "description@a8" => [
            clienttranslate(
                "<i>The Islanders are mystified by a massive island on the horizon, and they devote their resources to exploring it.</i>"
            ),
            clienttranslate("Start with 4 territory tiles in your supply."),
            clienttranslate(
                "<b>At the beginning of your income turns (1-5)</b>, you may explore 1 of the hexes on this mat (place a territory tile here and gain the exploration benefit and [VP], just as you would on the board). Additional hexes may also be explored on advance turns via exploration actions. Tiles placed here cannot be conquered."
            ),
            clienttranslate(
                "<b>On your final income turn</b>, gain [4VP] for each of these territory tiles that contain only water on the outer edges."
            ),
            clienttranslate(
                "<it>If you gain this civilization in the middle of the game, you may discard it and gain another. If you keep it, immediately place up to 4 of your territory tiles on these hexes (don't gain exploration benefits from this)</it>"
            ),
    ...
    CIV_RECYCLERS => [
        "name" => clienttranslate("RECYCLERS"), //34
        "description" => [
            clienttranslate(
                "The Recyclers take used technology and make it new again. Start by gaining 3 tech cards from the deck; discard 2 and keep 1, placing it in your bottom row. You may not upgrade it during your first income turn."
            ),
            clienttranslate(
                "At the beginning of your income turns (2-5), you may upgrade a tech card. This is in addition to the standard upgrade during each of those income turns."
            ),
            clienttranslate(
                "When upgrading, the Recyclers may upgrade a card from the top row to the bottom row. Whenever you do this, gain 5 VP."
            ),
        ...
        "description@a8" => [
            ...
            clienttranslate(
                "Start by drawing 3 tech cards from the deck; discard 2 and keep 1, placing it in your bottom row. You may not upgrade it during your first income turn."
            ),
            clienttranslate(
                "<b>At the beginning of your income turns (2-5)</b>, you may gain the top card of the tech discard pile, then you may upgrade a tech card. This is in addition to the standard upgrade during those turns."
            ),
    ...
    CIV_RIVERFOLK => [
        "name" => clienttranslate("RIVERFOLK"),
        "description" => [
            ...
            clienttranslate(
                "You may place buildings on impassable plots of land in your capital city. Impassable plots still help the Riverfolk complete districts, rows, and columns."
            ),
            "",
            clienttranslate(
                "Whenever you cover the last impassable plot in a district, gain [ANY RESOURCE]. This benefit does not apply in districts with no impassable plots."
            ),
    ...
    CIV_SPIES => [
        "name" => clienttranslate("SPIES"),
        "description" => [
            clienttranslate("The Spies use subterfuge and deception to leech information from neighboring nations."),
            "",
            clienttranslate(
                "At the beginning of your income turns (2-5), you may place a player token on one of the unselected options here to gain the corresponding benefit from a neighboring player of your choice."
            ),
        ...
        "description@a8" => [
            3 => clienttranslate(
                "If you do, you may peek at the chosen neighbor's hand of tapestry cards. You may tell other players what you saw."
            ),
        ],
        "income_trigger" => ["from" => 2, "to" => 5],
        "slot_choice" => "unoccupied",
    ...
    CIV_TINKERERS => [
        "name" => clienttranslate("TINKERERS"),
        "description" => [
            clienttranslate("The Tinkerers are masters of time and technology."),
            clienttranslate(
                "If you start the game with the Tinkerers, each opponent gains a tech card from the deck, placing it in their bottom row. They may not upgrade tech cards during their first income turn."
            ),
            clienttranslate(
                "At the beginning of your income turns (2-5), you may place a player token on one of the unselected options here and act accordingly."
            ),
            clienttranslate(
                "Unless otherwise noted, do not gain the advancement benefits or bonuses as a result of these player token manipulations."
            ),
            "",
            //
        ],
    ...
    CIV_TREASURE_HUNTERS => [
        "name" => clienttranslate("TREASUREHUNTERS"),
        "description" => [
            clienttranslate(
                "The Treasure Hunters look for riches wherever they go, and they seek to protect their valuables from other civilizations."
            ),
            clienttranslate("Start with 4 player tokens here and gain 2 territory tiles."),
            "",
            clienttranslate(
                "At the beginning of your income turns (2-5), you may place a player token from here on an empty territory adjacent to a territory you control that displays the listed terrain type (this is not a conquer action, but you now control the territory). Gain the corresponding treasure."
            ),
            "",
        ...
        "description@a8" => [
            ...
            "",
            clienttranslate(
                "<li>Desert: Gain [COIN], then roll the black conquer die up to 2 times and gain the benefit of the final roll."
            ),
            clienttranslate(
                "<li>Grassland: Gain [CULTURE], then roll the science die up to 2 times and gain the benefit of the final roll."
            ),
            ...
            clienttranslate(
                "Territories controlled by one of your player tokens can be conquered; this is considered a topple of your token."
            ),
    ...
    CIV_UTILITARIENS => [
        "name" => clienttranslate("UTILITARIANS"),
        "description" => [
            ...
            clienttranslate(
                "Start with 2 player tokens here (1 on the first landmark you selected). After you gain a landmark on this list, you may place or move 1 of the player tokens on this mat next to that landmark's name to activate the corresponding ability."
            ),
            clienttranslate(
                "<it>If you gain this civilization in the middle of the game, you may immediately place up to 2 player tokens next to the corresponding landmark abilities on this mat if you have those landmarks</it>"
            ),
        ],
        "description@a8" => [
            clienttranslate("<i>Utilitarians create functional landmarks.</i>"),
            clienttranslate(
                "If you start the game with the Utilitarians, choose a tier II landmark and place it here. <b>At the beginning of your second income turn</b>, place it in your capital city."
            ),
            clienttranslate(
                "Start with 2 player tokens here (1 on the first landmark you selected). After you gain a landmark on this list, you may place or move 1 of the player tokens on this mat next to that landmark's name to activate the corresponding ability (you may have a max of 2 active abilities at a time)."
            ),
            clienttranslate(
                "<i>If you gain this civilization in the middle of the game, you may either discard it and draw another or keep it and immediately place up to 2 player tokens next to the corresponding landmark abilities on this mat if you have those landmarks.</i>"
            ),
        ],
        "midgame_ben@a8" => ["or" => [174, 173]],
        "midgame_setup@a8" => true,
        ...
        "slots" => [
            ...
            5 => [
                ...
                "cl" => "activatable",
                "title" => clienttranslate(
                    "Lighthouse: Once on each of your advancement turns you may discard 2 [TERRITORY TILE] to gain [ANY REOURCE]"
                ),
            ],
...
$this->capitals = [
    1 => [
        ...
        "grid" => ["000000000", "110001110", "000111000", "000111110", "000001100", "011100001", "001000000", "000000010", "001000000"],
    ],
    2 => [
        "name" => clienttranslate("Wetland"),
        "start" => ["large" => "-3_0", "small" => "0_2"], // 2/4
        "grid" => ["000000001", "110000111", "000000000", "011100110", "001100000", "111000010", "000001100", "011000000", "000001000"],
    ],
    3 => [
        "name" => clienttranslate("Tropical"),
        "start" => ["large" => "0_3", "small" => "2_0"], // 3/5
        "grid" => ["000010011", "000100011", "001000001", "000000000", "010001000", "000000000", "101101010", "011110000", "001110000"],
    ],
    4 => [
        "name" => clienttranslate("Desert"),
        "start" => ["large" => "3_3", "small" => "0_2"], // 2/4
        "grid" => ["000110000", "101000000", "100000110", "000000000", "010010011", "011000001", "011111000", "001100000", "000001000"],
    ],
    5 => [
        "name" => clienttranslate("Grassland"),
        "start" => ["large" => "3_0", "small" => "2_0"], // 3/5
        "grid" => ["000000000", "111000010", "111100000", "000111100", "000000111", "111000001", "001000000", "000000100", "000001000"],
    ],
    6 => [
        "name" => clienttranslate("Forest"),
        "start" => ["large" => "0_-3", "small" => "-2_-2"], // 1/6
        "grid" => ["000000000", "001100100", "000100010", "011000001", "000100000", "001111100", "010000100", "001000111", "000000011"],
    ],
];
$this->income_tracks = [
    1 => [
        ...
        "color" => "yellow",
        "resource" => "coin",
        1 => ["name" => clienttranslate("Barter"), "benefit" => [BE_GAIN_COIN, BE_VP_TECH]],
        2 => ["name" => clienttranslate("Currency"), "benefit" => [BE_GAIN_COIN]],
        3 => ["name" => clienttranslate("Banking"), "benefit" => [BE_VP_TECH]],
        4 => ["name" => clienttranslate("Credit Cards"), "benefit" => [BE_GAIN_COIN]],
        5 => ["name" => clienttranslate("E-Commerce"), "benefit" => [BE_GAIN_COIN, BE_VP_TECH]],
        6 => ["name" => clienttranslate("Biometrics"), "benefit" => [510]],
    ],
    2 => [
        ...
        "color" => "grey",
        "resource" => "worker",
        1 => ["name" => clienttranslate("Symbology"), "benefit" => [BE_GAIN_WORKER, BE_VP_CAPITAL]],
        2 => ["name" => clienttranslate("Language"), "benefit" => [BE_GAIN_WORKER]],
        3 => ["name" => clienttranslate("Writing"), "benefit" => [BE_VP_CAPITAL]],
        4 => ["name" => clienttranslate("Telephone"), "benefit" => [BE_GAIN_WORKER]],
        5 => ["name" => clienttranslate("Email"), "benefit" => [BE_GAIN_WORKER, BE_VP_CAPITAL]],
        6 => ["name" => clienttranslate("Neural Implants"), "benefit" => [510]],
    ],
    3 => [
        ...
        "color" => "brown",
        "resource" => "food",
        1 => ["name" => clienttranslate("Hunting"), "benefit" => [BE_GAIN_FOOD, BE_TERRITORY]],
        2 => ["name" => clienttranslate("Farming"), "benefit" => [BE_GAIN_FOOD]],
        3 => ["name" => clienttranslate("Breeding"), "benefit" => [504]],
        4 => ["name" => clienttranslate("Preservation"), "benefit" => [BE_GAIN_FOOD]],
        5 => ["name" => clienttranslate("Fertilization"), "benefit" => [BE_GAIN_FOOD, 507]],
        6 => ["name" => clienttranslate("Food Printing"), "benefit" => [510]],
    ],
    4 => [
        ...
        "color" => "red",
        "resource" => "culture",
        1 => ["name" => clienttranslate("Ceremony"), "benefit" => [BE_GAIN_CULTURE, BE_TAPESTRY]],
        2 => ["name" => clienttranslate("Racing"), "benefit" => [BE_GAIN_CULTURE]],
        3 => ["name" => clienttranslate("Team Sports"), "benefit" => [BE_VP_TERRITORY]],
        4 => ["name" => clienttranslate("Tabletop Games"), "benefit" => [BE_GAIN_CULTURE]],
        5 => ["name" => clienttranslate("Video Games"), "benefit" => [BE_GAIN_CULTURE, BE_VP_TERRITORY]],
        6 => ["name" => clienttranslate("Virtual Reality"), "benefit" => [510]],
    ],
];
...
$this->card_types = [
    ...
    113 => [
        // fake cards to represent decks for Mystics new edition
        "deck" => "deck_13",
        "discard" => "discard_13",
