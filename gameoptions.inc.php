...
$game_options = [
    100 => [
        ...
        'values' => [
            ...
            4 => ['name' => totranslate('with Experimental Adjustments Nov 2022 (Deprecated)'),'beta'=>true, 'description' => totranslate('experimental rules')],
            8 => ['name' => totranslate('Adjustment Civilization Pack'),'alpha'=>true, 'description' => totranslate('official expansion')],
        ],
//             'startcondition' => [
