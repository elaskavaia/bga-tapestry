...
$game_preferences = [
    PREF_AUTO_CONFIRM => [
        ...
        "values" => [
            PREFVALUE_AUTO_CONFIRM_OFF => ["name" => totranslate("No Auto Confirm"), "cssPref" => "tap_confirm_manual"],
            PREFVALUE_AUTO_CONFIRM_ON => ["name" => totranslate("Auto Confirm"), "cssPref" => "tap_confirm_auto"],
            PREFVALUE_AUTO_CONFIRM_TIMER => ["name" => totranslate("Auto Confirm with Timer"), "cssPref" => "tap_confirm_timer"],
        ],
    ...
    PREF_SHOW_STACK => [
        ...
        "needReload" => true, // after user changes this preference game interface would auto-reload
        "values" => [
            0 => ["name" => totranslate("No"), "cssPref" => "show_breadcrumbs_no"],
            1 => ["name" => totranslate("Yes"), "cssPref" => "show_breadcrumbs_yes"],
        ],
        "default" => 0,
        "server_sync" => false,
    ],
