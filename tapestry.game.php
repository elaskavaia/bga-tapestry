 ...
 *
 */
require_once('modules/tapcommon.php');
require_once "modules/civs/AbsCivilization.php";
require_once "modules/civs/BasicCivilization.php";

class Tapestry extends tapcommon {
    // material
